...
function Contact(props: {
  ...
  return (
    <Link href={`/${props.chatId}`}>
      <div className="flex flex-row hover:bg-white/10 py-3 px-3 rounded-xl cursor-pointer">
        <div className="basis-1/4">
          <img
            src={props.profilePicURL!}
            alt={`profile picture of ${props.person}`}
...
export function ContactList() {
  ...
  const profiles: Array<{
    ...
    {
      person: "PythonIsSlow",
      lastMsg: "wanna play minecraft with me?",
      profilePicURL:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLA994hpL3PMmq0scCuWOu0LGsjef49dyXVg&s",
      chatId:
        "ANd9GcTLA994hpL3PMmq0scCuWOu0LGsjef49dyXVg&sANd9GcTLA994hpL3PMmq0scCuWOu0LGsjef49dyXVg&sANd9GcTLA994hpL3PMmq0scCuWOu0LGsjef49dyXVg&s",
    },
  ];
  return (
    <div className="w-96 h-full basis-1/5 bg-neutral-800 p-3">
...
function ChatWindow() {
  return (
    <div className="w-full h-full basis-3/5 bg-neutral-800">
